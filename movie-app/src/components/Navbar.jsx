...
const Navbar = () => {
    ...
    const navBackgroundClass = scrolled
        ? darkMode
            ? "bg-[#0a0b0f]/90 backdrop-blur-md shadow-lg border-b border-white/5"
    ...
    return (
        ...
        >
                ...
                <form onSubmit={handleSearch} className="hidden md:flex flex-1 mx-12 max-w-xl relative group">
                    ...
                    <input
                        ...
                        className={`w-full pl-12 pr-4 py-2.5 rounded-full text-sm font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500/50 ${darkMode
                            ? "bg-white/10 text-white placeholder-gray-400 border border-transparent focus:bg-black/40 focus:ring-offset-[#0a0b0f]"
            ...
            <motion.div
                ...
                className={`fixed inset-0 z-40 pt-24 px-6 md:hidden flex flex-col gap-6 backdrop-blur-xl ${darkMode ? "bg-[#0a0b0f]/95" : "bg-white/95 supports-[backdrop-filter]:bg-white/80"
                    }`}
            >
