...
const Profile = () => {
    ...
    return (
        isAuthenticated && (
            ...
            <div className={`min-h-screen w-full flex justify-center items-start pt-32 px-4 transition-colors duration-300 ${darkMode ? "bg-[#0a0b0f]" : "bg-gray-50"
                }`}>
                <motion.div
                    ...
                    className={`relative backdrop-blur-xl p-10 rounded-3xl shadow-2xl max-w-2xl w-full text-center border overflow-hidden transition-all duration-300 ${darkMode
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            ...
                            <img
                                src={user.picture}
                                alt={user.name}
                                className={`relative w-40 h-40 rounded-full border-4 shadow-xl object-cover transition-colors duration-300 ${darkMode ? "border-[#1a1c24]" : "border-white"
                                    }`}
                            />
                        </motion.div>
                        ...
                        <motion.h2
                            ...
                            className={`text-4xl font-bold mb-2 transition-colors duration-300 ${darkMode ? "text-white" : "text-gray-900"
                                }`}
                        >
                            {user.name}
                        </motion.h2>
                        ...
                        <motion.p
                            ...
                            className={`text-lg mb-8 transition-colors duration-300 ${darkMode ? "text-gray-400" : "text-gray-600"
                                }`}
                        >
                            {user.email}
                        </motion.p>
...
const DetailBox = ({ label, value, darkMode }) => (
    <div className={`p-4 rounded-xl border transition-colors duration-300 ${darkMode
